...
export default function TicketPage() {
    ...
    const TicketOption = ({ title, price, count, increment, decrement }) => (
        <div className="ticket-price-container">
            <h3 className="price-tag-name">{title}</h3>
            <p className="price-tag-name">Pris: {price}Kr</p>
            <button className="add-ticket" onClick={increment}>+</button>
            <input className="quantity" type="text" value={count} disabled />
            <button className="remove-ticket" onClick={decrement}>-</button>
        </div>
    );
