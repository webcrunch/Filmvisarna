    ...
    <>
      <nav>
        {s.menu.map(({ label, path }) =>
          label ? (
            <NavLink className="navlinks" to={path}>
              {label}
            </NavLink>
          ) : null
        )}
        ...
        <div className={"boxContent " + (l.opened ? "shown" : "hidden")}>
          <div>
            <p>
              {open.loggedin ? (
                <Link to={"/yourlist"}>
                  <img src={"./images/icons8-movie-theater-24.png"} alt={""} />
                  Mina bokningar
                </Link>
              ) : null}
            </p>
            <p>
              {open.loggedin ? (
                ...
                <Link to={"/authenticate"}>
                  <img src={"./images/icons8-log-in-25.png"} alt={""} />
                  Logga in
                </Link>
              )}
            </p>
            <p>
              <Link to={"/register"}>
                <img src={"./images/icons8-add-user-male-24.png"} alt={""} />{" "}
                Registrera sig
              </Link>
            </p>
          </div>
