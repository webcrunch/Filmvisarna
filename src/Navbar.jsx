    ...
    return <>
        <nav>
            ...
            <div className={"boxContent " + (l.opened ? 'shown' : 'hidden')}>
                <div>
                    <p>{open.loggedin ? <Link onClick={() => logout()} to={"#"}><img src={"./images/icons8-log-out-25.png"} alt={""} />Log out</Link> : <Link to={"/authentication"}><img src={"./images / icons8 -log-in-25.png"} alt={""} />Login</Link>}</p>
